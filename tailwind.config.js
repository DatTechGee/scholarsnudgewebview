  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card': '0 4px 6px -1px rgba(0,0,0,.08), 0 2px 4px -2px rgba(0,0,0,.05)',
        'card-hover': '0 10px 15px -3px rgba(0,0,0,.1), 0 4px 6px -4px rgba(0,0,0,.05)',
        'nav': '0 4px 6px -1px rgba(0,0,0,.1)',
      },
      animation: {
